...
#define kSMALLBALLWIDTH         ((20/320.0)*(SCREEN_WIDTH))
#define kRrrr                   (SCREEN_WIDTH/2 - kSMALLBALLWIDTH/2)
#define kSmallBallScale         (kSMALLBALLWIDTH / 100.0f)
...
//  调试环境地址
//#define KBSSDKAPIURL                @"http://121.40.214.35:82/"
//#define KBSSDKAPIDomain             @"http://121.40.214.35:82/index.php/"
