...
@property (nonatomic, strong) NSString  * nickname;   // 昵称 必填
@property (nonatomic, strong) NSString  * name;       // 姓名 必填
...
@property (nonatomic, assign) int         isfinanc;   // 是否是融资商户 0:未申请 1:审核中 2:已申请
@property (nonatomic, assign) BOOL        isshop;     // 是否是商户
@property (nonatomic, assign) BOOL        isexhi;     // 是否是展会会员
@property (nonatomic, assign) BOOL        iscomm;     // 是否有公众号
@property (nonatomic, assign) BOOL        hasShopPass;// 商城独立密码
@property (nonatomic, assign) BOOL        hasExhiPass;// 展会独立密码
...
@property (nonatomic, strong) Financ    * financ;
...
/**
 *	Copyright © 2013 sam Inc. All rights reserved.
 *
[""] *	为索引排序
[""] *
