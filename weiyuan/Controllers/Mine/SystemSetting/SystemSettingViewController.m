...
- (IBAction)signOut:(id)sender {
    CameraActionSheet *actionSheet = [[CameraActionSheet alloc] initWithActionTitle:@"确定要退出登录吗?"  TextViews:nil CancelTitle:@"取消" withDelegate:self otherButtonTitles:@"确定退出", nil];
    [actionSheet show];
}
