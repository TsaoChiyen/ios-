...
- (UIView *)headerBar {
    ...
    segmentedControl.frame = CGRectMake(20.0, 4.0, self.view.width - 40, 32.0);
...
-(void)segmentAction:(UISegmentedControl *)Seg{
    ...
    switch (idx) {
        case 0:
            strClass = @"XAddrBookViewController";
            break;
            
        case 1:
            strClass = @"FriendsCircleViewController";
            break;
            
        case 2:
            strClass = @"MeetingViewController";
            break;
            
        case 3:
            strClass = @"GroupListViewController";
            break;
...
- (UITableViewCell*)tableView:(UITableView *)sender cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell update:^(NSString *name) {
        [cell autoAdjustText];
        cell.labTime.right = cell.width - 10;
