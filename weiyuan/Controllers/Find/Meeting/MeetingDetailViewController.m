...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"秘室详细";
    
    [contentArr addObjectsFromArray:@[@"秘室名称", @"主持人", @"起始时间", @"结束时间"]];
    ...
    UILabel * label = [UILabel singleLineText:@"秘室主题" font:[UIFont systemFontOfSize:14] wid:100 color:RGBCOLOR(44, 44, 44)];
    ...
    if (_item.isInValid) {
        ...
        [joinButton setTitle:@"进入秘室" forState:UIControlStateNormal];
        ...
        if (_item.isjoin) {
            ...
            if (_item.isOwer) {
                if (!inviteButton) {
                    ...
                    [inviteButton setTitle:@"邀请秘聊" forState:UIControlStateNormal];
                    ...
                    [managerButton setTitle:@"秘室管理" forState:UIControlStateNormal];
            ...
            [joinButton setTitle:@"申请秘聊" forState:UIControlStateNormal];
            [joinButton navStyle];
            self.meetTheamview.height = meetHeight;
            managerButton.hidden = inviteButton.hidden = YES;
        }
