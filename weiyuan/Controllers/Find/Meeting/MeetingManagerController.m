...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"秘室管理";
    ...
    [inviteButton setTitle:@"处理秘聊申请" forState:UIControlStateNormal];
    ...
    [managerButton setTitle:@"秘聊用户活跃度排行" forState:UIControlStateNormal];
